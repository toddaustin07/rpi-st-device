...
**02/15/23 NOTICE:  A new release of the SmartThings core SDK for Direct Connected Devices (v.1.8.0) is now available and it supports a Raspberry Pi configuration natively, so my package here is longer required.  Refer to the ["raspberry" subdirectory](https://github.com/SmartThingsCommunity/st-device-sdk-c/tree/release/v1.8/example/raspberry) within the SDK example directory.**
